...
const TString inputdir  = "histo_Minitree_nJet_em";
const TString outputdir = "fig_Minitree_nJet/";
...
void Plotter(TString option = "hist"){
  ...
  float lumi = 35.867;//lumi_fb_2016;
 ...
 /* plotter.AddProcess("11_HWW",       "HWW",        color_HWW);
  ...
  plotter.AddProcess("15_VZ",        "VZ",         color_VZ);
 ...
 // plotter.Draw( "mt2lblb"        , "M_{T2}(" + sl + "b" + sl + "b)",    10, 0, "GeV",  scale, false, 0, 600);
  ...
  plotter.Draw( "nbjet30csvv2l"  , "number of 20 GeV csvv2l b-jets",    -1, 0, "NULL", scale, true, 0,  6);
  plotter.Draw( "nbjet30csvv2m"  , "number of 20 GeV csvv2m b-jets",    -1, 0, "NULL", scale, true, 0,  6);
  plotter.Draw( "nbjet30csvv2t"  , "number of 20 GeV csvv2t b-jets",    -1, 0, "NULL", scale, true, 0,  6);
  plotter.Draw( "njet"           , "number of 20 GeV jets",             -1, 0, "NULL", scale, true, 0,  10);
