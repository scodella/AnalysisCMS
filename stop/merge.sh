...
hadd -f -k 03_ZZ.root        ZZTo2L2Nu__part*.root ggZZTo2e2nu.root ggZZTo2mu2nu.root
##hadd -f -k 03a_ZZ.root        ZZTo2L2Nu__part*.root 
##hadd -f -k 03b_ZZ.root        ggZZTo2e2nu.root ggZZTo2mu2nu.root
...
##rm DY*_DYcorr.root
#hadd -f -k 07_ZJetsHT.root   DYJetsToLL_M-10to50-LO.root DYJetsToLL_M-5to50_HT-*root DYJetsToLL_M-50-LO-ext1__part*.root 
DYJetsToLL_M-50_HT-70to100__part* DYJetsToLL_M-50_HT-100to200_ext1__part* DYJetsToLL_M-50_HT-200to400_ext1__part* DYJetsToLL_M-50_HT-400to600.root DYJetsToLL_M-50_HT-600to800__part* DYJetsToLL_M-50_HT-800to1200.root DYJetsToLL_M-50_HT-1200to2500.root DYJetsToLL_M-50_HT-2500toInf.root  
...
#hadd -f -k 14_ZZTo4L.root        ZZTo4L__part*.root ggZZTo4mu.root ggZZTo4e.root ggZZTo4tau.root ggZZTo2e2mu.root ggZZTo2mu2tau.root ggZZTo2e2tau.root qqHToZZTo4L.root ggHToZZTo4L.root
#hadd -f -k 14a_ZZTo4L.root        ZZTo4L__part*.root 
#hadd -f -k 14b_ZZTo4L.root        ggZZTo4mu.root ggZZTo4e.root ggZZTo4tau.root ggZZTo2e2mu.root ggZZTo2mu2tau.root ggZZTo2e2tau.root 
#hadd -f -k 14c_ZZTo4L.root        qqHToZZTo4L.root ggHToZZTo4L.root
hadd -f -k 15_VZ.root        WZTo2L2Q__part*.root ZZTo2L2Q__part*.root 
